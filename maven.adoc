...
de bibliothèques https://repo.maven.apache.org/maven2/. Ce site, maintenu par
...
Pour notre dépendance à JavaMail, nous obtenons : https://repo.maven.apache.org/maven2/javax/mail/mail/1.4/.
